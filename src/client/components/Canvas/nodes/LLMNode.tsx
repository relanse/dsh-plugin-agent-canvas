  ...
  return (
    <div className={`rf-node rf-node--llm status--${status}`}>
      ...
      <div className="rf-node__body">
        ...
        <div className="rf-node__field" style={{ marginTop: 6 }}>最大步数</div>
